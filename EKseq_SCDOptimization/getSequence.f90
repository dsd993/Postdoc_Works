...
program main
  ...
  real(8) :: emin, emax, dx, x, e0, e0o, et
  character(len=1) :: ss
  ...
  !below loop runs for 1,000,000 iterations to pick the sequence with minimum SCD
  do imc = 1, NMAX
     e0o = e0
     seqo = seq
  ...
  !below loop runs for 1,000,000 iterations to pick the sequence with maximum SCD
  do imc = 1, NMAX
     e0o = e0
     seqo = seq
     i1 = int(seq_length*grnd()) + 1
